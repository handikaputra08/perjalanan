    ...
    <div class="col-sm">
        <div class="page-header text-center">
            <div class="page-title">
                <h1>Input Surat Perintah Tugas</h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row" style="margin-right:auto; margin-left:auto; padding:10px; display:block">
            <div style="height: 255px; border: 1px solid rgb(228, 228, 228);">
                <form action="insertdata" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <button type="submit" name="submit" class="btn btn-primary" style="border-radius: 7px; position: absolute; bottom: -40px; right: 16px;">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
